...
SECRET_KEY = 'django-insecure-s4wfd*%^gj6wf+a%r6=&4&o!g6hd^fv#7bxd)$&p%bwf-)bmfz'
...
TEMPLATES = [
    {
        ...
        # A MUDANÇA É AQUI: Coloque o caminho direto dentro da lista
        'DIRS': [
            os.path.join(BASE_DIR, 'templates'),
        ],
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'django.contrib.auth.context_processors.auth',
                'django.contrib.messages.context_processors.messages',
                'carrinho.context_processors.carrinho',  # Adiciona o context processor do carrinho
            ],
        },
    },
]
...
LOGGING = {
    ...
    'formatters': {
        'simple': {
            'format': 'Mensagem: {message} - Tempo: {asctime}',
            'datefmt': '%d/%m/%Y %H:%M:%S',
            'style': '{',
},
